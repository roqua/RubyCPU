...
describe "An instance of", RubyCpu do
  ...
  let(:correlation) { [0.32733] }
  let(:ocpu_package) { OcpuPackage.new(calculation_request.package) }
  let(:ruby_cpu) { RubyCpu.new "https://public.opencpu.org" }
